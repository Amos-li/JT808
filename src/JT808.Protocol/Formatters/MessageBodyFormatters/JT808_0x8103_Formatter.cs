...
{
    public class JT808_0x8103_Formatter : IJT808Formatter<JT808_0x8103>
    {
        public JT808_0x8103 Deserialize(ReadOnlySpan<byte> bytes, out int readSize, IJT808Config config)
        {
            int offset = 0;
            ...
            for (int i = 0; i < paramCount; i++)
            {
                ...
                {
                    jT808_0x8103.ParamList.Add(JT808FormatterResolverExtensions.JT808DynamicDeserialize(JT808FormatterExtensions.GetFormatter(type), bytes.Slice(offset), out readSubBodySize, config));
                }
        ...
        public int Serialize(ref byte[] bytes, int offset, JT808_0x8103 value, IJT808Config config)
        {
