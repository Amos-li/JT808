...
{
    public class JT808_0x0200_0x01_Formatter : IJT808Formatter<JT808_0x0200_0x01>
    {
        public JT808_0x0200_0x01 Deserialize(ReadOnlySpan<byte> bytes, out int readSize, IJT808Config config)
        {
            int offset = 0;
        ...
        public int Serialize(ref byte[] bytes, int offset, JT808_0x0200_0x01 value, IJT808Config config)
        {
