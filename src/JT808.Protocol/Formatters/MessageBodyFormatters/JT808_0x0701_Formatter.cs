...
namespace JT808.Protocol.Formatters.MessageBodyFormatters
{
    ...
    {
        public JT808_0x0701 Deserialize(ReadOnlySpan<byte> bytes, out int readSize, IJT808Config config)
        {
            ...
            jT808_0X0701.ElectronicContent = JT808FormatterResolverExtensions.JT808DynamicDeserialize(
                JT808FormatterExtensions.GetFormatter(JT808_0x0701.JT808_0x0701Body.BodyImpl), 
                bytes.Slice(offset, (int)jT808_0X0701.ElectronicWaybillLength), 
                out int readSubBodySize, 
                config);
