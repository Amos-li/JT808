...
namespace JT808.Protocol.Formatters.MessageBodyFormatters
{
    ...
    {
        public JT808_0x8103_0x0006 Deserialize(ReadOnlySpan<byte> bytes, out int readSize, IJT808Config config)
        {
            int offset = 0;
        ...
        public int Serialize(ref byte[] bytes, int offset, JT808_0x8103_0x0006 value, IJT808Config config)
        {
