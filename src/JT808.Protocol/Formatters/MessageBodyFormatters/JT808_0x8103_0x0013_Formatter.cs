...
{
    public class JT808_0x8103_0x0013_Formatter : IJT808Formatter<JT808_0x8103_0x0013>
    {
        public JT808_0x8103_0x0013 Deserialize(ReadOnlySpan<byte> bytes, out int readSize, IJT808Config config)
        {
            int offset = 0;
        ...
        public int Serialize(ref byte[] bytes, int offset, JT808_0x8103_0x0013 value, IJT808Config config)
        {
            offset += 1;
